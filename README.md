...
### must install
```
rofi rofi-emoji swaybg hyprlock waybar wlogout fish kitty polkit-gnome starship hyprshot dunst power-profiles-daemon wl-clipboard wl-clip-persist cliphist 
